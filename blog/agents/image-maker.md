...
| 파일 | 역할 |
|------|------|
| `output/[주제]/draft.md` | 이미지 마커 위치와 글 전체 분위기 파악 |
...
4. 저장: `output/[주제]/images/thumbnail.png`
...
- **저장 위치: `output/[주제]/tmp_html/body-{n}.html`** — 반드시 `tmp_html/` 폴더 사용
...
- 저장 경로: `output/[주제]/images/body-{n}.png` (n은 마커 순서, 1부터 시작)
...
`output/[주제]/user-images/` 폴더가 존재할 경우 아래 순서로 처리한다.
